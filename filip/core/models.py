...
class DataType(str, Enum):
    ...
    COMMAND_RESULT = "commandResult", "An entity containing a command, contains an " \
                                      "autogenerated attribute of this type"
    COMMAND_STATUS = "commandStatus", "An entity containing a command, contains an " \
                                      "autogenerated attribute of this type"
