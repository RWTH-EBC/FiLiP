...
#         )
#
#         vocabulary_1 = VocabularyConfigurator.add_ontology_to_vocabulary_as_file(
#             vocabulary=vocabulary,
#             path_to_file=self.get_file_path("ontology_files/RoomFloorOntology.ttl"),
#         )
#
#         with open(
#             self.get_file_path("ontology_files/RoomFloor_Duplicate_Labels.ttl"), "r"
#         ) as file:
#             data = file.read()
#
#         vocabulary_2 = VocabularyConfigurator.add_ontology_to_vocabulary_as_string(
#             vocabulary=vocabulary_1,
#             source_name="RoomFloorOntology_Duplicate_Labels",
#             source_content=data,
#         )
#
#         vocabulary_3 = VocabularyConfigurator.add_ontology_to_vocabulary_as_file(
#             vocabulary=vocabulary,
#             path_to_file=self.get_file_path("ontology_files/RoomFloorOntology.ttl"),
...
#             path_to_file=self.get_file_path("ontology_files/ParsingTesterOntology.ttl"),
#         )
#
...
#         # test source names
#         self.assertIn(
#             "RoomFloorOntology", [n.source_name for n in vocabulary_1.sources.values()]
#         )
#
#         self.assertIn(
#             "RoomFloorOntology", [n.source_name for n in vocabulary_2.sources.values()]
#         )
#         self.assertIn(
#             "RoomFloorOntology_Duplicate_Labels",
#             [n.source_name for n in vocabulary_2.sources.values()],
#         )
#
#         self.assertIn(
#             "test_name", [n.source_name for n in vocabulary_3.sources.values()]
#         )
#
...
#         source_id = [
#             s.id for s in vocabulary_3.sources.values() if s.source_name == "test_name"
#         ][0]
...
#         )
#         self.assertNotIn(
#             "test_name", [n.source_name for n in vocabulary_4.sources.values()]
#         )
#
...
#
#         conflict_summary = VocabularyConfigurator.get_label_conflicts_in_vocabulary(
#             conflict_voc
#         )
#
...
#         self.assertIn("MeasurmentType", conflict_summary.datatype_label_duplicates)
#
#         self.assertEqual(len(conflict_summary.class_label_duplicates["Sensor"]), 2)
#
#     def test_valid_test(self):
#         self.assertEqual(
#             VocabularyConfigurator.is_vocabulary_valid(self.vocabulary_2), False
#         )
#         self.assertEqual(
#             VocabularyConfigurator.is_vocabulary_valid(self.vocabulary_1), True
#         )
#         self.assertEqual(
#             VocabularyConfigurator.is_vocabulary_valid(self.vocabulary_3), True
#         )
#
...
#
#         class_thing = vocabulary.get_class_by_iri("http://www.w3.org/2002/07/owl#Thing")
#
