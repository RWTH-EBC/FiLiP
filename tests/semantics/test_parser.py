...
#         with open(
#             get_file_path("ontology_files/ParsingTesterOntology.ttl"), "r"
#         ) as file:
#             data = file.read()
#
...
#
#         # class annotations
#         self.assertEqual(vocabulary.get_class_by_iri(iri("Class1")).label, "Class1")
#         self.assertEqual(
#             vocabulary.get_class_by_iri(iri("Class2")).get_label(), "Class2"
#         )
#         self.assertEqual(
#             vocabulary.get_class_by_iri(iri("Class1")).comment.lower(),
#             "comment on class 1",
#         )
#
#         # subclassing
#         assertList(
#             vocabulary.get_class_by_iri(iri("Class1")).parent_class_iris,
...
#             ["http://www.w3.org/2002/07/owl#Thing", iri("Class1"), iri("Class1a")],
#         )
#
#         assertList(
#             vocabulary.get_class_by_iri(iri("Class3")).child_class_iris,
#             [iri("Class3a"), iri("Class123"), iri("Class3aa"), iri("Class13")],
#         )
#
#         # Relation Target statments
#         cor1 = get_cor_with_prop(vocabulary, iri("Class1"), iri("objProp3"))
#         assertList(
#             get_targets_for_combine_object_relation(vocabulary, cor1),
#             [
#                 iri("Class3"),
#                 iri("Class123"),
#                 iri("Class3a"),
...
#         assertList(
#             get_targets_for_combine_object_relation(vocabulary, cor1), [iri("Class123")]
#         )
#         cor1 = get_cor_with_prop(vocabulary, iri("Class1"), iri("oProp1"))
#
#         assertList(
#             get_targets_for_combine_object_relation(vocabulary, cor1),
#             [iri("Class4"), iri("Class2"), iri("Class12"), iri("Class123")],
#         )
...
#
#         target_str = (
#             get_cor_with_prop(vocabulary, iri("Class1"), iri("objProp5"))
#             .get_relations(vocabulary)[0]
#             .target_statement.to_string(vocabulary)
#         )
...
#         )
#         assertList(
#             vocabulary.get_object_property(iri("objProp3")).inverse_property_iris,
#             [iri("oProp1")],
#         )
#
#         # datatype_catalogue
#         assertList(
#             vocabulary.get_datatype(iri("customDataType1")).enum_values,
#             ["0", "15", "30"],
#         )
#         assertList(
#             vocabulary.get_datatype(iri("customDataType4")).enum_values,
#             ["1", "2", "3", "4"],
#         )
#         self.assertEqual(
#             vocabulary.get_datatype(iri("customDataType4")).type, DatatypeType.enum
#         )
#
#         # data properties
...
#         assertList(
#             cdr1.get_possible_enum_target_values(vocabulary), ["1", "2", "3", "4"]
#         )
#
...
#
#
# def get_cdr_with_prop(vocabulary: Vocabulary, class_iri: str, prop_iri: str):
#     # cors = vocabulary.get_combined_object_relations_for_class(class_iri)
#     class_ = vocabulary.get_class_by_iri(class_iri=class_iri)
...
#     assert collections.Counter(actual) == collections.Counter(expected), actual
#
#
# def iri(iriEnd: str):
#     base_iri = (
#         "http://www.semanticweb.org/redin/ontologies/2020/11/" "untitled-ontology-25#"
#     )
#     return base_iri + iriEnd
#
#
# def get_targets_for_combine_object_relation(vocabulary: Vocabulary, com_obj_rel):
