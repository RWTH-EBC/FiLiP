...
WRITE_GROUPS_FILEPATH = Path("../e5_iot_thermal_zone_control_solution_groups.json")
WRITE_DEVICES_FILEPATH = Path("../e5_iot_thermal_zone_control_solution_devices.json")
WRITE_SUBSCRIPTIONS_FILEPATH = Path(
    "../e5_iot_thermal_zone_control_solution_subscriptions.json"
)
...
if __name__ == "__main__":
    ...
    cmd = DeviceCommand(name="heater_on", type=DataType.BOOLEAN)
