...
from filip.semantics.semantics_manager import SemanticsManager, InstanceRegistry
...
class Room(Thing):
    ...
    name: DataField = DataField(
        name="name", rule="exactly 1 string", semantic_manager=semantic_manager
    )

    volume: DataField = DataField(
        name="volume", rule="some rational", semantic_manager=semantic_manager
    )
    ...
    hasSensor: RelationField = RelationField(
        name="hasSensor", rule="only Sensor", semantic_manager=semantic_manager
    )

    hasTenant: RelationField = RelationField(
        name="hasTenant", rule="only Tenant", semantic_manager=semantic_manager
    )
...
class Building(Thing):
    ...
    hasFloor: RelationField = RelationField(
        name="hasFloor", rule="min 1 Floor", semantic_manager=semantic_manager
    )
...
class Sensor(SemanticDeviceClass, Thing):
    ...
    unit: DataField = DataField(
        name="unit", rule="exactly 1 Unit", semantic_manager=semantic_manager
    )
...
class Floor(Thing):
    ...
    hasRoom: RelationField = RelationField(
        name="hasRoom", rule="only Room", semantic_manager=semantic_manager
    )
...
class Circuit(Thing):
    ...
    hasProducer: RelationField = RelationField(
        name="hasProducer", rule="min 1 Producer", semantic_manager=semantic_manager
    )
