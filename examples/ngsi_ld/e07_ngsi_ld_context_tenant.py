...
if __name__ == "__main__":
    ...
    default_client = ContextBrokerLDClient(fiware_header=default_header,url=CB_URL)
    ...
    custom_client = ContextBrokerLDClient(fiware_header=custom_header,url=CB_URL)
    ...
    default_client.post_entity(entity=ContextLDEntity(
        context=[
            "https://n5geh.github.io/n5geh.test-context.io/context_saref.jsonld"
        ],
        **temperature_sensor_dict,
    ...
    custom_client= ContextBrokerLDClient(url=CB_URL,fiware_header=custom_header)
    ...
    temperature_sensor.add_properties([NamedContextProperty(name="temperature",value=50,unitCode="CEL")])
